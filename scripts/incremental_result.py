...
def main()->int:
    ...
    result={"schema_version":1,"applab_version":"0.9.0","repository":a.repository,"ref":a.ref,"resolved_sha":a.resolved_sha,
      "history_key":a.history_key,"run_id":a.run_id,"result":"PASS","analysis_mode":"fast","analysis_lane":lane,
      "risk_score":plan.get("risk_score"),"confidence":plan.get("confidence"),"runtime_reused_from":plan.get("baseline_sha",""),
