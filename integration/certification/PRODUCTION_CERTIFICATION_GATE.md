...
The v0.9 Adaptive Impact Engine is intentionally non-reductive in CERTIFICATION mode: certification always selects the complete mandatory lab set and full release-quality checks. NO_RUNTIME_CHANGE, STATIC_ONLY and selective FAST_RUNTIME lanes can never satisfy production certification.
